\begin{resumo}
    ...
    Desse modo, foi realizado um estudo de caso, estruturado pela abordagem \textit{Goal Question Metric} (GQM) e fundamentado por uma revisão da literatura. 
    ...
    Os resultados indicaram que a automação proporcionou a identificação eficaz de vulnerabilidades nas perspectivas de qualidade interna e externa, apesar de a pipeline ter apresentado indicadores iniciais de baixo desempenho devido à alta taxa de falhas detectadas. 
